...
export default class Quina extends Component{
  ...
  async getConcursos() {
    const concursos = await api.get('/contests/3')
      ...
      <div className="es-quina">
        ...
        <form onSubmit={e => this.handleSubmit(e)}>
          <ul className="escolha-quina">
            ...
            <li><button id='61' value={61} onClick={e => this.selectNum(e)}>61</button></li>
            <li><button id='62' value={62} onClick={e => this.selectNum(e)}>62</button></li>
            <li><button id='63' value={63} onClick={e => this.selectNum(e)}>63</button></li>
            <li><button id='64' value={64} onClick={e => this.selectNum(e)}>64</button></li>
            <li><button id='65' value={65} onClick={e => this.selectNum(e)}>65</button></li>
            <li><button id='66' value={66} onClick={e => this.selectNum(e)}>66</button></li>
            <li><button id='67' value={67} onClick={e => this.selectNum(e)}>67</button></li>
            <li><button id='68' value={68} onClick={e => this.selectNum(e)}>68</button></li>
            <li><button id='69' value={69} onClick={e => this.selectNum(e)}>69</button></li>
            <li><button id='70' value={70} onClick={e => this.selectNum(e)}>70</button></li>
            <li><button id='71' value={71} onClick={e => this.selectNum(e)}>71</button></li>
            <li><button id='72' value={72} onClick={e => this.selectNum(e)}>72</button></li>
            <li><button id='73' value={73} onClick={e => this.selectNum(e)}>73</button></li>
            <li><button id='74' value={74} onClick={e => this.selectNum(e)}>74</button></li>
            <li><button id='75' value={75} onClick={e => this.selectNum(e)}>75</button></li>
            <li><button id='76' value={76} onClick={e => this.selectNum(e)}>76</button></li>
            <li><button id='77' value={77} onClick={e => this.selectNum(e)}>77</button></li>
            <li><button id='78' value={78} onClick={e => this.selectNum(e)}>78</button></li>
            <li><button id='79' value={79} onClick={e => this.selectNum(e)}>79</button></li>
            <li><button id='80' value={80} onClick={e => this.selectNum(e)}>80</button></li>
          </ul>
